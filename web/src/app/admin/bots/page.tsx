  ...
  return (
    <div className="mb-8">
      ...
      <p className="mb-2 text-sm text-muted-foreground">
        Setup Slack bots that connect to Assistant. Once setup, you will be able to
      ...
      <div className="mb-2">
        <ul className="list-disc mt-2 ml-4 text-sm text-muted-foreground">
          <li>
            Setup AssistantBot to automatically answer questions in certain channels.
          </li>
          <li>
            Choose which document sets AssistantBot should answer from, depending on
            the channel the question is being asked.
          </li>
          <li>
            Directly message AssistantBot to search just as you would in the web UI.
          </li>
        </ul>
      </div>
